...
function criarCardVendedor(vendedor, totalVendas) {
  ...
  card.innerHTML = `
    ...
    <div class="vendedor-card__metrics">
      ...
      <div><span>Custo dos aprovados</span><strong>${formatarMoeda(vendedor.custoAprovados)}</strong></div>
      <div><span>Valor da venda</span><strong>${formatarMoeda(vendedor.faturamento)}</strong></div>
