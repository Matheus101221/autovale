...
const NOME_ABA_VENDEDORES = "Desempenho por vendedor";
const SHEET_URL_VENDEDORES = `https://docs.google.com/spreadsheets/d/${SPREADSHEET_ID}/gviz/tq?tqx=out:json&sheet=${encodeURIComponent(NOME_ABA_VENDEDORES)}`;
