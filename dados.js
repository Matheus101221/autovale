...
function calcularIndicadoresPeriodo(lancamentos) {
  ...
  /* Porcentagem Média Retorno (manual): soma das porcentagens digitadas na coluna
     "Porcentagem" da planilha (todos os lançamentos do período), dividida pelo
     total de contratos do período */
  ind.percentualMedioRetorno = ind.contratos > 0 ? somaPercentualManual / ind.contratos : 0;
